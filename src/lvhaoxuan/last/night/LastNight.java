...
public class LastNight extends JavaPlugin {
    ...
    public static HashMap<String, RandomItemGroup> resourceDropsMap = new HashMap<>();
    ...
    public static boolean clearRecipes = true;
    ...
    public static final String MAIL_INVENTORY = "邮箱 将物品放入邮箱被吞概不负责！";
    public static final String MAKER = "将物品放入后关闭背包进行锻造";
    public static final String BACK_MESSAGE = "§b物品已经回到你的背包";
    public static final String MAIL_FULL_MESSAGE = "§4邮箱已满，请整理留出空位";
    public static final String FORGE_SUCCESS_MESSAGE = "§a锻造成功 物品已寄往邮箱/ln mail打开邮箱";
